...
Reviewed all 66 core catalog entries by exported API, implementation, preview imports, displayed source, and Usage. The 368 extracted workspace card patterns remain blocks; they retain their business layout and demo behavior.
...
| `integration-list` | Workspace connections, account details, and asynchronous connect/disconnect actions. |
