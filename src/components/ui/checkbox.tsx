...
>(({ className, checked = false, onCheckedChange, ...props }, ref) => (
  <button
    ...
    className={cn(
      "peer h-4 w-4 shrink-0 rounded-sm border border-input bg-card shadow-xs transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/30 focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50",
