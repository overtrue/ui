...
try {
 ...
 await page.getByPlaceholder('Search tasks…').fill('does-not-exist');await page.getByText('No tasks match this search.').waitFor();check(await page.getByText('No tasks match this search.').isVisible(),'task empty search');
